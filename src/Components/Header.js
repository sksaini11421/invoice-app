...
const Header = ({handlePrint}) => {
    ...
    return (
        ...
        justify-between mb-5 xl:flex-row xl:justify-between">
                <div>
                    <h1 className="font-bold
            uppercase tracking-wide text-4xl mb-3">Invoicer</h1>
                </div>
            ...
            justify-between flex-wrap">
                        <li>
                            <button onClick={handlePrint}
                                className="bg-gray-500 py-2 px-8 rounded shadow
                        ...
                        <li className='mx-2'>
                            <button
                                className="bg-blue-500 py-2 px-8 rounded shadow
